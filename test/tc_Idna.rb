...
class Test_Idna < MTest::Unit::TestCase
  ...
  TESTCASES_JOSEFSSON = {
    'A' => [
      [ 0x0644, 0x064A, 0x0647, 0x0645, 0x0627, 0x0628, 0x062A, 0x0643,
        ...
        0x061F ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + 'egbpdaj6bu4bxfgehfvwxn'
    ],

    'B' => [
      [ 0x4ED6, 0x4EEC, 0x4E3A, 0x4EC0, 0x4E48, 0x4E0D, 0x8BF4, 0x4E2D,
        0x6587 ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + 'ihqwcrb4cv8a8dqg056pqjye'
    ],

    'C' => [
      [ 0x4ED6, 0x5011, 0x7232, 0x4EC0, 0x9EBD, 0x4E0D, 0x8AAA, 0x4E2D,
        0x6587 ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + 'ihqwctvzc91f659drss3x8bo0yb'
    ],
    ...
    'D' => [
      ...
      ::IDN::Idna::ACE_PREFIX + 'Proprostnemluvesky-uyb24dma41a'
    ],
    ...
    'E' => [
      ...
      ::IDN::Idna::ACE_PREFIX + '4dbcagdahymbxekheh6e0a7fei0b'
    ],
    ...
    'F' => [
      ...
      ::IDN::Idna::ACE_PREFIX + 'i1baa7eci9glrd9b2ae1bj0hfcgg6iyaf8o0a1dig0cd'
    ],
    ...
    'G' => [
      ...
      ::IDN::Idna::ACE_PREFIX + 'n8jok5ay5dzabd5bym9f0cm5685rrjetr6pdxa'
    ],
    ...
    'H' => [
      ...
      ::IDN::Idna::ACE_PREFIX + 'b1abfaaepdrnnbgefbadotcwatmq2g4l'
    ],
    ...
    'I' => [
      [ 0x0050, 0x006F, 0x0072, 0x0071, 0x0075, 0x00E9, 0x006E, 0x006F,
        ...
        0x006C ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + 'PorqunopuedensimplementehablarenEspaol-fmd56a'
    ],
    ...
    'J' => [
      ...
      ::IDN::Idna::ACE_PREFIX + 'TisaohkhngthchnitingVit-kjcr8268qyxafd2f1b9g'
    ],

    'K' => [
      [ 0x0033, 0x5E74, 0x0042, 0x7D44, 0x91D1, 0x516B, 0x5148,
        0x751F ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + '3B-ww4c5e180e575a65lsy2b'
    ],
    ...
    'L' => [
      [ 0x5B89, 0x5BA4, 0x5948, 0x7F8E, 0x6075, 0x002D, 0x0077, 0x0069,
        ...
        0x0053 ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + '-with-SUPER-MONKEYS-pc58ag80a8qai00g7n9n'
    ],
  ...
  TESTCASES_UNASSIGNED = {
    'A' => [
      [ 0x0221 ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + '6la'
    ],

    'B' => [
      [ 0x0236 ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + 'sma'
    ]
  }
  ...
  TESTCASES_STD3 = {
    'A' => [
      ...
      ::IDN::Idna::ACE_PREFIX + 'ste--kva'
    ],

    'B' => [
      [ 0x006F, 0x003A, 0x006C, 0x006B, 0x01EB, 0x0065 ].pack('U*'),
      ::IDN::Idna::ACE_PREFIX + 'o:lke-m1b'
    ]
  }
  ...
  def test_toASCII_UNASSIGNED_ALLOWED
    TESTCASES_UNASSIGNED.each do |key, val|
      rc = ::IDN::Idna.toASCII(val[0], ::IDN::Idna::ALLOW_UNASSIGNED)
  ...
  def test_toASCII_UNASSIGNED_NOT_ALLOWED
    TESTCASES_UNASSIGNED.each do |key, val|
      assert_raise(::IDN::Idna::IdnaError, "TestCase #{key} failed") do
        ::IDN::Idna.toASCII(val[0])
      end
    end
  end
  ...
  def test_toASCII_STD3_USED
    TESTCASES_STD3.each do |key, val|
      assert_raise(::IDN::Idna::IdnaError, "TestCase #{key} failed") do
        ::IDN::Idna.toASCII(val[0], ::IDN::Idna::USE_STD3_ASCII_RULES)
      end
    end
  end
  ...
  def test_toUnicode_UNASSIGNED_ALLOWED
    TESTCASES_UNASSIGNED.each do |key, val|
      rc = ::IDN::Idna.toUnicode(val[1], ::IDN::Idna::ALLOW_UNASSIGNED)
      assert_equal(val[0], rc, "TestCase #{key} failed")
    end
  end
  ...
  def test_toUnicode_STD3_USED
    TESTCASES_STD3.each do |key, val|
      rc = ::IDN::Idna.toUnicode(val[1], ::IDN::Idna::USE_STD3_ASCII_RULES)
      assert_equal(val[1], rc, "TestCase #{key} failed")
    end
  end
